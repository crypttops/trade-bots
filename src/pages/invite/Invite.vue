  ...
  <div class="invite">
      ...
      <div class="promotion-tools">
        ...
        <div class="tools">
          <div class="item" @click="showCardItem">
              <img src="https://urzz.oss-cn-hangzhou.aliyuncs.com/2019/08/08/promotioncard.png"></img>
          ...
          <div class="item" @click="useInviteImage">
              <img src="https://urzz.oss-cn-hangzhou.aliyuncs.com/2019/08/08/invitebg.jpg"></img>
    ...
    <Drawer :title="$t('invite.pt_title')" :closable="false" v-model="showCardModal" width="600">
      <div class="ptcard-header">
        <img class="card-img" src="https://urzz.oss-cn-hangzhou.aliyuncs.com/2019/08/08/promotioncard.png"></img>
        <div class="desc">
