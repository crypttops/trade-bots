    ...
    <div class="login_right">
      <Form v-if="allowRegister" ref="formInline" :model="formInline" :rules="ruleInline" inline>
        ...
        <FormItem prop="user">
          <Input type="text" v-model="formInline.user" :placeholder="key" v-if="changeActive==0">
            <Select v-model="country" slot="prepend" style="width: 65px;border-bottom: 1px solid #27313e;">
              <Option value="中国" label="+254"><span>+254</span><span style="margin-left:10px;color:#ccc">{{$t('uc.regist.kenya')}}</span></Option>
        ...
        <FormItem prop="code">
          ...
          <input id="sendCode" @click="success" type="Button" shape="circle" :value="sendcodeValue" :disabled='codedisabled'>
          </input>
        </FormItem>
