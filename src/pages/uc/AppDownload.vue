  ...
  <div class="login_form app-download">
    <div class="login_right">
      <div style="color: #000;margin-bottom: 60px;padding-top: 160px;width: 100%;text-align:center;z-index: 10;">
        ...
        <p style="font-size:18px;">Crypttops</p>
    ...
    <div class="cover" id="cover" @click="coverClick"><img src="https://urzz.oss-cn-hangzhou.aliyuncs.com/appdowncover.png"></img></div>
  </div>
</template>
...
export default {
  data() {
    return {
      country: "中国",
      version: "1.0.0",
      publishTime: "2021/08/08/08/08 12:32:00"
    };
  },
  watch: {
    lang: function() {
  ...
  methods: {
    init() {
      window.document.title = (this.lang == "zh_CN" ? "APP下载 - " : "APP Download - ") + "Crypttops | Global digital currency trading platform";
      this.getVersion();
    },
    downloadClick(){
      if(this.isWeiXin()){
        ...
        location.href = "https://urzz.oss-cn-hangzhou.aliyuncs.com/1.apk";
      }
    },
    downloadClick2(){
      if(this.isWeiXin()){
