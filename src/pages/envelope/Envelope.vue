...
export default {
  data() {
    return {
      ...
      hasInviteUser: false,
      inviteUserId: "***********",
      inviteUserAvatar: "https://urzz.oss-cn-hangzhou.aliyuncs.com/defaultavatar.png",
      envelopeInfo: {
        id: 0,
        name: "**********",
        totalAmount: "0.00",
        ...
        invite: 0,
        type: 0,
        logo: "https://urzz.oss-cn-hangzhou.aliyuncs.com/applogo.png",
        bgImage: "https://urzz.oss-cn-hangzhou.aliyuncs.com/redenvelope.png",
        state: 0,
        detail: "留给未来一个暴富的可能"
      },
      formInline: {
