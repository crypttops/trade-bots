    ...
    <div class="wrapper">
      ...
      <div class="content_wrapper">
        ...
        <div class="content1" style="border:none;">
          ...
          <p>{{$t('description.twitter')}}：https://twitter.com/</p>
          <p>{{$t('description.biyong')}}：https://0.plus/</p>
          <p>{{$t('description.telegram')}}：https://t.me/</p>
          <p>{{$t('description.medium')}}：https://medium.com/N</p>
          <p>{{$t('description.reddit')}}：https://www.reddit.com/</p>
        </div>
      </div>
    </div>
  </div>
