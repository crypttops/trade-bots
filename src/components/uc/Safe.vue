            ...
            <div class="account-in">
              ...
              <div class="account-item">
                <div class="account-item-in">
                  ...
                  <span v-if="user.phoneVerified == 1">{{
                    $t("uc.safe.binded")
                  }}</span>
                  <a v-else class="btn" @click="showItem(3)">{{
                    $t("uc.safe.bind")
                  }}</a>
                </div>
...
<span>{{ $t("uc.safe.phone") }}</span>
                        <Select
                          v-model="country"
                          style="width: 65px; border-bottom: 1px solid #27313e"
                        >
                          <Option value="美国" label="+1"
                            ><span>+1</span
                            ><span style="margin-left: 10px; color: #ccc">{{
                              $t("uc.regist.American")
                            }}</span></Option
                          >
                          ...
                          <Option value="马来西亚" label="+60"
                            ><span>+60</span
                            ><span style="margin-left: 10px; color: #ccc">{{
                              $t("uc.regist.malaysia")
                            }}</span></Option
                          >
                          <Option value="台湾" label="+886"
                            ><span>+886</span
                            ><span style="margin-left: 10px; color: #ccc">{{
                              $t("uc.regist.taiwan")
                            }}</span></Option
                      ...
                      >
                        <Input v-model="formValidate3.vailCode2" size="large">
                          ...
                          <div class="timebox" slot="append">
                            <Button
                              @click="send(2)"
                              :disabled="sendMsgDisabled2"
                            >
                              <span v-if="sendMsgDisabled2">{{
                                time2 + $t("uc.safe.second")
                              }}</span>
                              <span v-if="!sendMsgDisabled2">{{
                                $t("uc.safe.clickget")
                              }}</span>
                      ...
                      >
                        <Input v-model="formValidate4.vailCode3" size="large">
                          ...
                          <div class="timebox" slot="append">
                            ...
                            >
                              <span v-if="sendMsgDisabled3">{{
                                time3 + $t("uc.safe.second")
                              }}</span>
                              <span v-if="!sendMsgDisabled3">{{
                                $t("uc.safe.clickget")
                              }}</span>
              ...
              <div class="account-item">
                <div class="account-item-in">
                  ...
                  <a
                    class="btn"
                    v-else-if="user.fundsVerified == 0"
                    @click="showItem(5)"
                    >{{ $t("uc.safe.set") }}</a
                  >
