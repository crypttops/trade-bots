          ...
          <div class="layout-ceiling-main">
              ...
              <Menu :active-name="activeNav" width="auto" :open-names="['1']">
                <Submenu name="1">
                  ...
                  <router-link to="/swap">
                   ...
                   <router-link to="/bot">
                    <MenuItem name="nav-bot">Bot</MenuItem>
                  </router-link>
            ...
            <div class="rr login-container">
              ...
              <div class="login_register isLogin" v-if="isLogin">
                <div class="mymsg">
                  <Button icon="md-add-circle" type="primary" @click="showSelectBotModal">Start New Bot</Button>
                </div>
                <div class="mymsg">
          ...
          <div class="social-list">
            <ul>
              <Tooltip content="Wechat" theme="dark" placement="top">
                ...
                <div slot="content">
                    <img style="width: 130px;border-radius: 5px;" src="./assets/images/appdownload.png">
                </div>
              </Tooltip>
              ...
              <Tooltip content="https://weibo.com/" theme="dark" placement="top">
                <li>
                  <Icon custom="i-icon iconfont iconweibo" />
                </li>
              </Tooltip>
              <Tooltip content="https://twitter.com/l" theme="dark" placement="top">
                <li>
                  <Icon type="logo-twitter" />
                </li>
              </Tooltip>
              <Tooltip content="https://medium.com/" theme="dark" placement="top">
                <li>
                  <Icon custom="i-icon iconfont iconmedium" />
                </li>
              </Tooltip>
              <Tooltip content="https://www.reddit.com/" theme="dark" placement="top">
                <li>
...
export default {
  ...
  watch: {
    activeNav: function() {
      switch (this.activeNav) {
        case "nav-exchange":
          window.document.title = (this.lang == "zh_CN" ? "交易中心" : "Exchange") + " - Crypttops | Global digital currency trading platform";
          break;
        case "nav-service":
          window.document.title = (this.lang == "zh_CN" ? "公告" : "Announcement") + " - Crypttops | Global digital currency trading platform";
          break;
        case "nav-about":
          window.document.title = (this.lang == "zh_CN" ? "关于" : "About") + " - Crypttops | Global digital currency trading platform";
          break;
        case "nav-lab":
          window.document.title = (this.lang == "zh_CN" ? "创新实验室" : "Lab") + " - Crypttops | Global digital currency trading platform";
          break;
        case "nav-invite":
          window.document.title = (this.lang == "zh_CN" ? "推广合伙人" : "Promotion") + " - Crypttops | Global digital currency trading platform";
          break;
	case "nav-cexchange":
          window.document.title = (this.lang == "zh_CN" ? "活动" : "Activity") + " - Crypttops | Global digital currency trading platform";
          break;
        default:
          window.document.title = "Crypttops - Crypto Trading Exchange and Bot";
          break;
      }
    },
    $route(to, from) {
  ...
  methods: {
    showSelectBotModal(){
      ...
      this.$root.$emit('showSelectedBotModal', true);
    },
    reload () {
...
　　let flag = navigator.userAgent.match(/(phone|pad|pod|iPhone|iPod|ios|iPad|Android|Mobile|BlackBerry|IEMobile|MQQBrowser|JUC|Fennec|wOSBrowser|BrowserNG|WebOS|Symbian|Windows Phone)/i)
    ...
    checkLogin() {
      this.$http.post(this.host + "/uc/check/login", {})
      .then(response => {
      ...
      .catch((error) => {
        console.log(`Error at /uc/check/login ${error}`)
      });
    },
